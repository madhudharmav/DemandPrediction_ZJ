...
format_drivers_asd_utilrate_lon_bt<-function(df_prediction_all,test_dates,df_test,clust_names){
  library(data.table)
 
  table_1<-format_realorders(df_prediction_all,test_dates)
...
format_drivers_asd_utilrate_ber_bt<-function(df_prediction_all,test_dates,df_test,clust_names){
  library(data.table)
...
format_drivers_asd_utilrate_par_bt<-function(df_prediction_all,test_dates,df_test,clust_names){
  library(data.table)
...
format_asd_values_bt<-function(df_prediction_all,test_dates,df_test,clust_names){
  library(data.table)
